export default function Navbar() {
  return (
    <>
  <nav className="sticky top-2 mx-auto bg-gradient-to-r from-[#1b2740]/90 via-[#22335a]/90 to-[#1b2740]/90 backdrop-blur-md flex items-center justify-between px-4 sm:px-6 py-1 sm:py-2 rounded-2xl shadow-md max-w-3xl w-full z-50 border border-blue-900/20">
