...
export function Section_Three() {
  ...
  return (
    <section className="bg-gradient-to-r from-[#0a1a33] to-[#0f2a66] py-16 px-6 md:px-12 lg:px-20 text-white">
      {/* Heading */}
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h2 className="text-3xl md:text-4xl font-bold">
          Most companies offer tools.{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
        {cards.map((card, index) => (
          <div key={index} className="flex flex-col items-center">
            {/* Icon inside circle */}
            <div className="w-20 h-20 flex items-center justify-center rounded-full bg-[#1a2f55] mb-6">
              {card.icon}
            </div>
